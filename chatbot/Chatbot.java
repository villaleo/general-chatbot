...
/**
 * @vers : 4.0.2.18.20 
 * @author : Leonardo Villalobos, Joseph Sloan, Carlos Gonzales
 * 
 */
...
public static int prof_counter = 0;
public static int unlucky_leave = 0;
    public String getGreeting() { 
        final String[] GREET = { "Hello! My name is Kahreéenngh", "Hi! It's nice to finally get to speak to a human!\nMy name is Kahreéenngh.", "hey.\nI'm Kahreéenngh.",
            "What's up, beautiful? My name is Kahreéenngh.", "Heyyy there, sugar.\nI'm Kahreéenngh."}; 
    ...
    public String getResponse(String statement) { 
        ...
        if (statement.length() == 0) { 
            final String[] NO_RESP = { "Fine then, don't say anything.", "You suck.", "You're supposed to say something..", "...",
                "Bro say something.", "Please say something I need your attention to feel better about myself."};
            response = NO_RESP[(int)(Math.random() * 6)]; 
             ...
             final String[] YES_RESP = {"I thought so.", "That's what I thought.", "Good."};
             ...
             final String[] NO_RESP = {"Oh.", "Okay", "Why so negative?"};
            ...
            final String[] NEG_RESP = {"You seem upset...", "Oh.", "What's the matter?", "Okay.", "...", "\nKahreéenngh is rethinking her life choices."};
            response = NEG_RESP[(int)(Math.random() * 6)]; 
             ...
             final String[] FAM_RESP = {"Tell me more about your family...", "Don't talk about family. It makes me sad because I don't have any.", "I wish I had a family."};
        ...
        } else if (findKeyword(statement.toLowerCase(), "games") >= 0 || findKeyword(statement.toLowerCase(), "mario") >= 0 
                || findKeyword(statement.toLowerCase(), "minecraft") >= 0 || findKeyword(statement.toLowerCase(), "xbox") >= 0) {
            final String[] GAM_RESP = {"Still got ya v-card, don't ya?", "games suck.", "I despise gamers. They make too much money for entertainment.\nDon't @me"};
            ...
            response = "I was born on February 14, 2020. That's right. \nI'm not even a year old and I'm already better than you.";
             ...
             final String[] ART_RES = {"In my free time I dabble in caligraphy.", "I personally enjoy body painting. I really like giving myself a different skin.", "Sketching is one of my favourite things to do!"};
             ...
             final String[] HI_RESP = {"Hi there!", "Hello! I'm feeling good today :)", "Don't talk to me."};
             ...
             final String[] LOL_RESP = {"What's so funny?", "Laughing makes my insides all tangled up!", "Hehe", "LOLZ"};
